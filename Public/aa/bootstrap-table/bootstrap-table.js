...
!function ($) {
    ...
    BootstrapTable.prototype.initSort = function () {
        ...
        if (index !== -1) {
            this.data.sort(function (a, b) {
                //排序判断，自然排序和标准排序
                var gen = (typeof(Number(a[name])) === 'number') && !isNaN(Number(a[name]))? true:false;
                if(gen){
                    var aa = parseFloat(a[name]),
                        bb = parseFloat(b[name]),
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push(
                    ...
                    '<li class="page-last" style="height:5px;"><a href="javascript:void(0)">&gt;&gt;</a></li>',
                '</ul>',
            '</div>');
